...
const Women = () => {
  const { womens } = useAuth();
 
   return (
     <div>
       <div  id='CATEGORY'>
         <h2 className="text-2xl text-[#3e4152] font-bold px-24 py-[3vw] tracking-[3px]">Women’s Wear Collection</h2>
         {
           Array.isArray(womens) && womens.length > 0 ? (
